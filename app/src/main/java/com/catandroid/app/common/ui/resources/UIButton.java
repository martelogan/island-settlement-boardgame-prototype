...
public class UIButton {
	...
	public enum ButtonType {
		...
		BUILD_CITY, BUILD_CITY_WALL, PLAY_PROGRESS_CARD, HIRE_KNIGHT, ACTIVATE_KNIGHT, PROMOTE_KNIGHT,
		PURCHASE_CITY_IMPROVEMENT, VIEW_BARBARIANS, CANCEL_ACTION, END_TURN
	}
