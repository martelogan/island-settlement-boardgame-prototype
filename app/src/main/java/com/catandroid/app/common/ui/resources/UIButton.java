...
public class UIButton {
	...
	public enum ButtonType {
		PLAYER_STATUS, TRADE, DICE_ROLL, BUILD_ROAD, BUILD_SHIP, MOVE_SHIP, BUILD_SETTLEMENT,
		BUILD_CITY, BUILD_CITY_WALL, PLAY_PROGRESS_CARD, HIRE_KNIGHT, ACTIVATE_KNIGHT,
        PROMOTE_KNIGHT, CHASE_ROBBER, CHASE_PIRATE, PURCHASE_CITY_IMPROVEMENT, VIEW_BARBARIANS,
        CANCEL_ACTION, END_TURN
	}
